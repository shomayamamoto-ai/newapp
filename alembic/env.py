...
The database URL always comes from the application's own settings, so a
...
from snsauto.config import get_settings  # noqa: E402
from snsauto.models import Base  # noqa: E402
